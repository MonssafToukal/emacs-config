...
(unless (display-graphic-p)
  (set-face-background 'dap-ui-marker-face "color- dap-ui-buffer-configurations
    `(
      ...
      (,dap-ui--expressions-buffer . ((side . right) (sssion))
)
...
(map! :leader
      (
        ...
        :desc "Locals" lot . 2) (window-width . 0.3)))
...
(defun next-expand()
  (interactive)
  (dap-next (dap--cur-se166") ; An orange background for the line to execute
...
;; if you use company-mode for completion (otherwise, complete-at-point works out of the 'go-mode-ho(after! lsp-mode
